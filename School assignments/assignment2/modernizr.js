...
!(function(e, n, t) {
  ...
  function m(e, t, r, o) {
    ...
    if (parseInt(r, 10))
      for (; r--; )
        (l = u("div")), (l.id = o ? o[r] : f + (r + 1)), c.appendChild(l);
    return (
      (s = u("style")),
      (s.type = "text/css"),
      (s.id = "s" + f),
      ...
      (i = t(c, e)),
      d.fake
        ? (d.parentNode.removeChild(d), (_.style.overflow = a), _.offsetHeight)
  ...
  function y(e, n, r, s) {
    ...
    for (
      ...
      (c = !0), (N.modElem = u(v.shift())), (N.style = N.modElem.style);
    for (p = e.length, d = 0; p > d; d++)
      if (
        ...
        if (s || o(r, "undefined")) return i(), "pfx" == n ? m : !0;
        try {
          N.style[m] = r;
        } catch (h) {}
        if (N.style[m] != y) return i(), "pfx" == n ? m : !0;
      }
    return i(), !1;
  }
